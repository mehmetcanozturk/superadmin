            ...
            <div class="col-12 lg:col-6 h-full px-4 py-4 md:px-6">
                ...
                <div class="grid formgrid">
                    ...
                    <div class="col-12 flex flex-column lg:flex-row justify-content-center align-items-center lg:justify-content-end my-6">
                        <Button class="p-button-secondary p-button-outlined mt-3 lg:mt-0 w-full lg:w-auto flex-order-2 lg:flex-order-1 lg:mr-4" label="Return to Cart" icon="pi pi-fw pi-arrow-left"></Button>
                        <Button class="p-button-primary w-full lg:w-auto flex-order-1 lg:flex-order-2" label="Continue to Shipping" icon="pi pi-fw pi-check"></Button>
                    </div>
                </div>
            </div>
