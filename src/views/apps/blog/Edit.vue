    ...
    <div class="card">
        ...
        <div class="grid">
            <div class="col-12 lg:col-8">
                <FileUpload ref="fileUploaderRef" id="files-fileupload" name="demo[]" accept="image/*" customUpload multiple auto class="border-1 surface-border surface-card p-0 border-round mb-4" :maxFileSize="1000000" @select="onSelectedFiles">
