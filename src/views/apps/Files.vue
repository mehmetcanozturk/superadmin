    ...
    <div class="grid">
        ...
        <div class="col-12 md:col-5 xl:col-3">
            ...
            <div class="card p-0">
                <Toast key="fu"></Toast>
                <div class="card">
                    <FileUpload ref="fileUploaderRef" id="files-fileupload" name="demo[]" accept="image/*" customUpload multiple auto class="upload-button-hidden w-full" :maxFileSize="1000000" @select="onSelectedFiles">
                        <template #content>
