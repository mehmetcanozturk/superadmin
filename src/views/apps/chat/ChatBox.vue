    ...
    <div class="flex flex-column h-full">
        <div class="flex align-items-center border-bottom-1 surface-border p-3 lg:p-6">
            ...
            <div class="flex align-items-center ml-auto">
                <Button type="button" icon="pi pi-phone" class="p-button-rounded p-button-outlined p-button-secondary mr-3"></Button>
        ...
        <div class="p-3 md:p-4 lg:p-6 flex flex-column sm:flex-row align-items-center mt-auto border-top-1 surface-border gap-3">
            ...
            <div class="flex w-full sm:w-auto gap-3">
                <Button class="p-button p-button-secondary w-full sm:w-auto justify-content-center text-xl" @click="(event) => $refs.op.toggle(event)">😀</Button>
