            ...
            <div class="card">
                <div class="flex flex-column md:flex-row md:align-items-start md:justify-content-between mb-3">
                    ...
                    <div class="inline-flex align-items-center">
                        ...
                        <Button icon="pi pi-upload" class="p-button-rounded mx-3 export-target-button" v-tooltip="'Export'" @click="exportCSV"></Button>
                    </div>
                </div>
                <DataTable
                    ref="salesTableRef"
                ...
                >
                    ...
                    <Column :style="{ textAlign: 'center' }">
                        <template #body>
                            <Button type="button" icon="pi pi-search" class="p-button-outlined p-button-rounded"></Button>
                        </template>
                    </Column>
                </DataTable>
            </div>
                        ...
                        <li v-if="i < 6" class="flex align-items-center justify-content-between p-3">
                            <div class="inline-flex align-items-center">
                                ...
                                <div class="flex flex-column ml-3">
                                    ...
                                    <Rating v-model="product.rating" readOnly :cancel="false" class="rating"></Rating>
                                </div>
                            </div>
