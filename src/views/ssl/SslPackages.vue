...
const sslPackages = ref([
    { id: 56465, packages: 'Comodo Positive SSL', brand: 'Comodo', type: 'DV (Domain Validation) SSL', algorithm: 'SHA-2', encryption: '1024-bit' },
    { id: 954, packages: 'Sectigo Positive SSL', brand: 'Sectigo', type: 'DV (Domain Validation) SSL', algorithm: 'RSA / ECC', encryption: '2048-bit / 256-bit' },
    { id: 654, packages: 'GeoTrust QuickSSL Premium', brand: 'GeoTrust', type: 'DV (Domain Validation) SSL', algorithm: 'SHA-2', encryption: '2048-bit' },
    { id: 689, packages: 'RapidSSL Certificate', brand: 'RapidSSL', type: 'DV (Domain Validation) SSL', algorithm: 'SHA-2', encryption: '2048-bit' }
]);
...
const priceType = ref();
const priceTypes = ref([{ name: 'Yeni Kayıt' }, { name: 'Yenileme' }]);
</script>
        ...
        <div class="col-12">
            <div class="card">
                ...
                <DataTable
                    ...
                    dataKey="id"
                    :globalFilterFields="['packages']"
                >
                    <template #header>
                        <div class="flex justify-content-between flex-column sm:flex-row">
                            <div class="flex flex-column sm:flex-row"></div>
                        </div>
                    </template>
                    <template #empty>
                    ...
                    <Column field="id" header="Ürün No" sortable>
                        <template #body="{ data }">
            ...
            <TabPanel>
                ...
                <DataTable :value="specialDefined" :paginator="true" :rowHover="false" scrollable scrollHeight="55dvh" :rows="10" dataKey="id" stripedRows v-model:filters="specialDefinedFilter" showGridlines v-model:expandedRows="expandedRows">
                    ...
                    <Column field="name" header="İsmi" sortable>
                        <template #body="slotProps"> <i class="pi pi-user mr-2"> </i>{{ slotProps.data.name }} </template>
                    </Column>
