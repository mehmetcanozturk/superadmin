    ...
    <Sidebar v-model:visible="layoutState.profileSidebarVisible.value" position="right" class="layout-profile-sidebar w-full sm:w-25rem">
        <div class="flex flex-column mx-auto md:mx-0">
            <div class="grid align-items-center">
                <div class="col-4"><img src="/images/user.jpg" alt="Profile" class="border-circle border-3 border-gray-300 hover:border-gray-500 transition-duration-500" /></div>
                <div class="col-6">
                    <div class="mb-2 font-semibold text-lg">Recep Şerit</div>
                    <div class="text-color-secondary font-medium ">Teknik Destek</div>
                </div>
            </div>
